...
//        	challengeReceived = 0;  // reset flag
//
//        	printf("Signing the challenge...\r\n");
//        	// sign the challenge
//        	SECURE_rsa_sign((byte *) challenge, strlen((char *) challenge), (byte *) signature, &sigLen);
//
//        	HAL_UART_Transmit(&huart1, signature, sigLen, HAL_MAX_DELAY);
//        }
//
//        // Riabilita la ricezione di nuovi dati (usiamo la modalità interrupt)
