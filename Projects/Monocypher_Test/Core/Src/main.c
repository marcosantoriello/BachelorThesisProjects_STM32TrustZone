...
void generate_ed25519_keys(void);
...
void process_command(const char *buffer) {
	if (strcmp(buffer, "PubKey") == 0) {
		send_message("Starting ECDSA key generation...\r\n");
...
int main(void)
{
  ...
  send_message("Type PubKey to generate ECDSA keys\r\n");
  /* USER CODE END 2 */
